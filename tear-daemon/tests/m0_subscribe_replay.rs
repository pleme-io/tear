...
fn to_ansi_emits_known_byte_sequence_for_known_grid() {
    let mut snap = PaneSnapshot {
        ...
        cols: 5,
        cells: vec![vec![
            Cell { ch: 'h', fg: Color::WHITE, bg: Color::BLACK, attrs: CellAttrs::NONE },
            Cell { ch: 'e', fg: Color::WHITE, bg: Color::BLACK, attrs: CellAttrs::NONE },
            Cell { ch: 'l', fg: Color::WHITE, bg: Color::BLACK, attrs: CellAttrs::NONE },
            Cell { ch: 'l', fg: Color::WHITE, bg: Color::BLACK, attrs: CellAttrs::NONE },
            Cell { ch: 'o', fg: Color::WHITE, bg: Color::BLACK, attrs: CellAttrs::NONE },
        ]],
        cursor_row: 0,
        cursor_col: 5,
