    ...
    crates = {
      ...
      "engate-attach" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "588952920b423f283a917d6c9cfc093452263f8d";
          sha256 = "1nb9pd2jalwp9z9055lzqmi7nv7vxs9c1x8m8yllxcrx1py6413q";
        };
      ...
      "ishou-tokens" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "89cf4e0400819259bcb5367ddce61f5269422ade";
          sha256 = "1n9k3pdnayvbv34qvryixk1nnp4j4zgnssncbzndx3sw7gipppm7";
        };
      ...
      "shidou" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "7718e61af849d49a8a75ee9cecf708fc76fc8326";
          sha256 = "1z1znn3inmxmfxgap1x1ky05qffsxv5gckkf250d5ans10fy2mky";
        };
        dependencies = [
          {
            name = "anyhow";
      ...
      "tear" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "rt-multi-thread" "macros" "sync" "io-util" ];
          }
          {
            name = "tracing";
            packageId = "tracing";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "cfg" "consoleapi" "evntrace" "fileapi" "handleapi" "impl-debug" "impl-default" "in6addr" "inaddr" "minwinbase" "minwindef" "namedpipeapi" "ntsecapi" "processenv" "processthreadsapi" "synchapi" "timezoneapi" "winbase" "windef" "winerror" "winioctl" "winnt" "winreg" "winsock2" "winuser" ];
      };
